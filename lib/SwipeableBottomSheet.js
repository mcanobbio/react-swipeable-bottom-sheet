...
var SwipeableBottomSheet = (function (_Component) {
	...
	_createClass(SwipeableBottomSheet, [{
		...
		value: function onOverlayClicked() {
			...
			var overlayClicked = _props2.overlayClicked;
		...
		value: function render() {
			...
			var overflowHeight = _props3.overflowHeight;
			var fullScreen = _props3.fullScreen;
			var marginTop = _props3.marginTop;
			var open = _props3.open;
			var topShadow = _props3.topShadow;
			var shadowTip = _props3.shadowTip;
			var overlay = _props3.overlay;
			var swipeableViewsProps = _props3.swipeableViewsProps;
			var scrollTopAtClose = _props3.scrollTopAtClose;
